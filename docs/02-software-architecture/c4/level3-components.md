...
**I would not start coding until these are complete:**
...
Identity domain design (aggregate, entities, use cases, events, ERD, API)



Once the Identity domain is fully designed, start implementing it. Then repeat the same cycle for each subsequent domain. This "design one domain ahead of development" approach gives you the benefits of solid architecture without spending months documenting features you may refine later.
